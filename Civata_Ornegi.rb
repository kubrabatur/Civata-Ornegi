...
# Create the head of the bolt
hex_curve = ent.add_circle [0, 0, 0], [0, 0, 1], 4
hex_face = ent.add_face hex_curve
hex_face.pushpull -3
# Create the screw and the bolt group
...
# Create the combined group and transform
